...
DEBUG = os.environ.get('DEBUG', 'False') == 'True'  # Ensure DEBUG is controlled via environment variable
ALLOWED_HOSTS = []

# For Render or other cloud services, set ALLOWED_HOSTS dynamically
